...
UPDATE PlayerColors SET PrimaryColor   = "COLOR_BZ_BLUE_DK"         WHERE Type = "LEADER_ASHOKA_ALT";
UPDATE PlayerColors SET SecondaryColor = "COLOR_BZ_ORANGE_LT"       WHERE Type = "LEADER_ASHOKA_ALT";
